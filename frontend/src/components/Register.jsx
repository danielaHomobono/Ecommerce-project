    ...
    <section className='h-screen flex items-center justify-center'>
        <div className='max-w-sm border shadow bg-white mx-auto p-8'>
            ...
            <input type="text" name='username' id='username'
                ...
                placeholder='Email Adress' required className='w-full bg-gray-100 focus:outline-none px-5 py-3'  
                />
                ...
                <button type='submit'
                className='w-full mt-5 bg-primary text-white hover:bg-indigo-500 font-medium py-3 rounded-md'>Register
                </button>
            </form>
